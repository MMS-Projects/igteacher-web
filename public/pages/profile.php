...
?>
<h3><?php echo $profile->username; ?><span class="red"><a href="<?php echo URL.'page/editprofile/'.$_GET['id']; ?>"><?php if($_SESSION['userid'] == $profile->ID || $_SESSION['rights'] >= 2){ echo language(85); } ?></a></span></h3>
